...
import com.hbm.items.special.ItemSatellite;
...
public class ModItems {
	...
	public static void initializeItem() {
		...
		sat_war = new ItemSatChip().setUnlocalizedName("sat_war").setMaxStackSize(1).setCreativeTab(null).setTextureName(RefStrings.MODID + ":sat_gerald");
